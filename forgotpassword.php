        ...
        <div class="d-flex flex-lg-row flex-column-reverse">
                ...
                <div class="row justify-content-center my-auto">
                    <div class="col-md-8 col-10 my-5">
                        ...
                        <form action="#">
                            ...
                            <div class="row justify-content-center my-3 px-3"> <button type="submit" class="btn-block btn-color">Reset Password</button> </div>
                        </form>
            ...
            <div class="card card2">
                <div class="my-auto mx-md-5 px-md-5 right">
                    <div class="row justify-content-center px-3 mb-3"> <img id="cake" src="assets/undraw_Safe_re_kiil.svg"> </div>
                </div>
            </div>
        </div>
    </div>
