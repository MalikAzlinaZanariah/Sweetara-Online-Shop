...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand navbar-link" href="#"><img src="assets/sweetara1.png" id="logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                if (isset($_SESSION["user_id"])) {
                    echo "<li class="active" role="presentation"><a href="account.php">Account</a></li>";
    ...
    <div class="container site-section cart-section" id="welcome">
        ...
        <div class="rowaccount">
                ...
                <h3>Welcome <?php echo $user_data['firstname']; ?>, You are Signed in! </h3>
